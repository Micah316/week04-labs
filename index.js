...
let drink = 'Coffee'
let myName = 'Micah'
let friendsName = 'Jessica'

console.log(food, drink, myName, friendsName);
//Question: Name a reason why you would use const instead of let.
//Answer: I would use const when I don't want the value to change. I would use let if I ever want to change the value.
...
*
* ↓ YOUR CODE HERE ↓ */
console.log(`My friend ${friendsName} & ${myName} are eating ${food} and drinking ${drink}`)
...
//Answer:
console.log(" My friend " + friendsName + " & " + myName  + " are eating " + food + " and are drinking " + drink);
...
//Answer: Assignment to error variable, meant that I was tryingt o change the value of a const which cannot be changed. Changing to let allowed value to be changed. 
...
const lunchtime = (foodChoice, drinkChoice) => {
    return `My friend ${friendsName} & ${myName} are eating ${foodChoice} and drinking ${drinkChoice}`
}
console.log(lunchtime('Pizza','Water'))
...
*
* Step 1: Create a ES6 fat arrow function called 'foodForTodayAndTomorrow' that takes 3 parameters: 
...
console.log(foodForTodayAndTomorrow ('Pizza', 'Soda', lunchtime('Turkey', 'Wine') ))
